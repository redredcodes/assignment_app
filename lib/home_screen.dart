...
class _HomeScreenState extends State<HomeScreen> {
        ...
        children: [
          Expanded(
            child: ListView(
              children: [
                // pullover
                buildPullover(_decrementCounter, pulloverCount, incrementCounterPullover, pulloverPrice),

                // t-Shirt
                buildTshirt(_decrementCounter, tShirtPrice),

                // sports dress
                buildSportDress(_decrementCounter, sportsDressPrice),
              ],
            ),
          ),
  ...
  Padding buildSportDress(void _decrementCounter(), int sportsDressPrice) {
    return Padding(
                padding: const EdgeInsets.all(10),
                child: Container(
                  height: 120,
  ...
  Padding buildTshirt(void _decrementCounter(), int tShirtPrice) {
    return Padding(
                padding: const EdgeInsets.all(10),
                child: Container(
                  height: 120,
  ...
  Padding buildPullover(void _decrementCounter(), int pulloverCount, void incrementCounterPullover(), int pulloverPrice) {
    return Padding(
                padding: const EdgeInsets.all(10),
                child: Container(
                  height: 120,
